...
<?php echo $this->Form->create('AlbumCover'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Album Cover'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AlbumCover.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AlbumCover.id'))); ?></li>
